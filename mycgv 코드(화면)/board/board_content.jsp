	...
	<div class="content">
		<section class="board_content">
			...
			<table class="content_layout">
				...
				<tr>
					<td colspan="6">
						<a href="board_update.jsp"><button type="button" class="btn_style2">수정</button></a>
						<a href="board_delete.jsp"><button type="button" class="btn_style2">삭제</button></a>
